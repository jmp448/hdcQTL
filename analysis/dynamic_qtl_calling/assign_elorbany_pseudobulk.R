...
elorbany_pseudobulk <- read_tsv("/project2/gilad/jpopp/sc-dynamic-eqtl/data/pseudobulk-cm/bin16/counts.tsv") %>%
  write_tsv("/project2/gilad/jpopp/ebQTL/data/dynamic_qtl_calling/elorbany_cm16bins/pseudobulk_tmm/elorbany_cm16bins.pseudobulk_tmm.tsv")
...
sample_summary <- sample_counts %>%
  rename(ind_type=binind, n_cells_unfiltered=n) %>%
  ...
  write_tsv("/project2/gilad/jpopp/ebQTL/data/dynamic_qtl_calling/elorbany_cm16bins/pseudobulk_tmm/sample_summary.tsv")
