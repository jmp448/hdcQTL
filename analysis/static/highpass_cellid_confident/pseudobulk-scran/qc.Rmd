...
```{r}
knitr::include_graphics(paste0("/project2/gilad/jpopp/ebQTL/figs/static/highpass_cellid_confident/pseudobulk-scran/", cell.types, "/qc.png"))
```
And check the shared pseudobulk profiles as well
```{r}
knitr::include_graphics("/project2/gilad/jpopp/ebQTL/figs/static/highpass_cellid_confident/pseudobulk-scran/Shared/qc.png")
```
