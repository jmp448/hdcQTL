...
```{r}
load("/project2/gilad/jpopp/ebQTL/results/static/cm_lineage2/pseudobulk_tmm/basic/4pcs/mashr.training_data.RData")
...
```{r}
all_qtls <- vroom(paste0("/project2/gilad/jpopp/ebQTL/results/static/cm_lineage2/pseudobulk_tmm/basic/", c("ipsc", "mesendo", "meso", "cp", "cm"), "/4pcs/matrixeqtl.cis_qtl_pairs.tophits.tsv"), id="path") %>%
