...
sample_summary <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/highpass_cellid_all/pseudobulk-scran/fastgxc_context_standardized/sample_summary_manual.tsv") %>%
...
prefix <- "/project2/gilad/jpopp/ebQTL/results/static/highpass_cellid_all/pseudobulk-scran/fastgxc_context_standardized/"
...
```{r}
m <- readRDS("/project2/gilad/jpopp/ebQTL/results/static/highpass_cellid_all/pseudobulk-scran/fastgxc_context_standardized/mashr.tophits.rds")
```
