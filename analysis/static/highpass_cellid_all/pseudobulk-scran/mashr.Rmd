...
sample_summary <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/highpass_cellid_all/pseudobulk-scran/sample_summary_manual.tsv") %>%
...
ct_summary <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/highpass_cellid_all/pseudobulk-scran/samples_per_celltype.tsv") %>%
...
```{r}
m <- readRDS("/project2/gilad/jpopp/ebQTL/results/static/highpass_cellid_all/pseudobulk-scran/mashr.tophits.rds")
```
...
m$result$lfsr %>%
  ...
  theme(axis.text.x = element_text(angle = 45, hjust=1))
```
There's a ton for erythroblasts - needs follow-up. Maybe this is because those are generally less mature, 
...
```{r}
ash_tophits <- readRDS("/project2/gilad/jpopp/ebQTL/results/static/highpass_cellid_all/pseudobulk-scran/ashr.tophits.rds")
