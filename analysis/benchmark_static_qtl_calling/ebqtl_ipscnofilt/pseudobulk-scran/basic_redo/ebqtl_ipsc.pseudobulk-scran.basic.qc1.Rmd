...
sample_summary <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/ebqtl_ipscfilt/pseudobulk-scran/sample_summary.tsv") %>%
...
How does this compare to Radhika's data?
```{r}
knitr::include_graphics(paste0("/project2/gilad/jpopp/ebQTL/figs/static/radhika_ipsc/pseudobulk-scran/basic_redo/", cell.types, "/qc.png"))
```
...
```{r}
eb_pcs <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/ebqtl_ipscfilt/pseudobulk-scran/basic_redo/IPSC/all_pcs.tsv")
```
