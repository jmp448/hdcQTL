...
```{r}
knitr::include_graphics(paste0("/project2/gilad/jpopp/ebQTL/figs/static/vqtl_ipsc/pseudobulk_tmm/basic/IPSC/qc.png"))
```

## PC Analysis
```{r}
sample_summary <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/vqtl_ipsc/pseudobulk_tmm/basic/sample_summary_manual.tsv") %>%
  mutate(individual=paste0("NA", individual))

pcs <- read_tsv("/project2/gilad/jpopp/ebQTL/data/static/vqtl_ipsc/pseudobulk_tmm/basic/IPSC/covariates.tsv") %>%
